...
const experiments = [
  ...
  },
  {
    ...
    subjectId: new ObjectId("685b2a1f3c4e8d0012a7b000"),
    experimentNumber: 4,
    problemStatement: "Program to demonstrate Function, Passing Arguments to a Function (call by value and call by reference",
    subExperiments: [
      {
        part: "a",
  ...
  },
  {
    ...
    subjectId: new ObjectId("685b2a1f3c4e8d0012a7b000"),
    experimentNumber: 5,
    problemStatement: "Implement an iterative and recursive functions for factorial/ Fibonacci series",
    subExperiments: [
      {
        part: "a",
        ...
        samples: [
          {
            input: "5",
            output: "Enter a number: Factorial of 5 = 120\nFibonacci series: 0 1 1 2 3 \n"
          }
        ]
      },
      {
    ...
    subExperiments: [
      {
        ...
        samples: [
          {
            input: "5\n4 1 3 5 2\n1\n6",
            output: "Enter number of elements: Enter array elements:\n\n--- 1D Array Operations ---\n1. Display\n2. Insert\n3. Delete\n4. Search\n5. Update\n6. Exit\nEnter choice: Array elements: 4 1 3 5 2 \n\n--- 1D Array Operations ---\n1. Display\n2. Insert\n3. Delete\n4. Search\n5. Update\n6. Exit\nEnter choice: "
          }
        ]
      },
      {
        ...
        samples: [
          {
            input: "2 2\n1 2\n3 4\n2 2\n5 6\n7 8\n1\n5",
            output: "Enter rows and columns of matrix A: Enter elements of matrix A:\nEnter rows and columns of matrix B: Enter elements of matrix B:\n\n--- Matrix Operations ---\n1. Display Matrices\n2. Addition\n3. Multiplication\n4. Transpose of A\n5. Exit\nEnter choice: \nMatrix A:\n1 2 \n3 4 \n\nMatrix B:\n5 6 \n7 8 \n\n--- Matrix Operations ---\n1. Display Matrices\n2. Addition\n3. Multiplication\n4. Transpose of A\n5. Exit\nEnter choice: "
          }
        ]
      }
    ]
    ...
    subExperiments: [
      {
        ...
        samples: [
          {
            input: "Hello\nWorld\n1\n6",
            output: "Enter first string: Enter second string: \n--- STRING OPERATIONS ---\n1. Length\n2. Copy\n3. Concatenate\n4. Compare\n5. Display Strings\n6. Exit\nEnter choice: Length of str1 = 5\nLength of str2 = 5\n\n--- STRING OPERATIONS ---\n1. Length\n2. Copy\n3. Concatenate\n4. Compare\n5. Display Strings\n6. Exit\nEnter choice: "
          }
        ]
      },
      {
  ...
  },
  {
    ...
    subExperiments: [
      {
        part: "a",
        title: "Define a Structure, Read and Store Details, and Display Stored Information",
        problemStatement: "Define a structure to store student/employee details, read and store multiple records, and display the stored information using structure arrays.",
        concepts: [
          "User-defined Data Types",
          "Structures",
          "Member Access Operator"
        ],
        theory: "A structure in C is a user-defined data type that allows grouping of variables of different data types under a single name. Each variable inside a structure is called a member and is accessed using the dot (.) operator. Arrays of structures allow storing multiple records efficiently. Data can be inserted, stored, and displayed using loops.",
    ...
    subExperiments: [
      {
        ...
        problemStatement: "Define a node structure for a linked list and implement insertion, deletion, and display operations on a singly linked list.",
        concepts: [
        ...
        theory: "A linked list is a dynamic linear data structure where each node contains data and a pointer to the next node. Unlike arrays, linked lists use non-contiguous memory and grow dynamically using malloc(). Each node is a self-referential structure containing a data field and a pointer to another node of the same type. Basic operations include insertion, deletion, and traversal.",
  ...
  },
  {
    ...
    subExperiments: [
      {
        part: "a",
        title: "Open a File to Store Student Records, Add, Update, and Display Records and Ensure Data Persistence",
        problemStatement: "Implement file handling in C to store student records, perform add/update/display operations, and ensure data persistence.",
        concepts: [
          "File Handling in C",
          "File Modes (r, w, a)",
          "File I/O Functions (fopen, fprintf, fscanf, fclose, fflush)"
        ],
        theory: "File handling in C allows permanent storage of data using files. Structures can be written to files using fprintf() or fread(). Files are opened using modes like 'r' (read), 'w' (write), and 'a' (append). Data persistence is ensured by immediately writing updates to the file and properly closing it using fclose(). fflush() forces buffer data to be written to disk, ensuring integrity.",
  ...
  },
  {
    ...
    subjectId: new ObjectId("685b2a1f3c4e8d0012a7b000"),
    experimentNumber: 12,
    problemStatement: "Implement one small application using Function, Files, Structure and Pointers",
    subExperiments: [
      {
        part: "a",
        title: "Functions – Add, Display, Search Books, Files – Store and Retrieve Book Data, Structures – Represent a Book, Pointers – Manage Book List Dynamically",
        problemStatement: "Implement a library management system using C that demonstrates structures, functions, pointers, and file handling for managing book records.",
        concepts: [
          "Structures in C",
