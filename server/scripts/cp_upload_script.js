    ...
    subExperiments: [
      {
        ...
        flowchart: {
          nodes: [
            ...
            { id: "2", type: "process", label: "Define struct Student" },
            { id: "3", type: "input", label: "Read n" },
            { id: "4", type: "process", label: "i = 0" },
            { id: "5", type: "decision", label: "i < n?" },
            { id: "6", type: "input", label: "Read student[i] details" },
            { id: "7", type: "process", label: "i++" },
            { id: "8", type: "output", label: "Display student[i] details" },
          ...
          edges: [
            ...
            { source: "3", target: "4" },
            { source: "4", target: "5" },
            { source: "5", target: "6", label: "Yes (Input Phase)" },
            { source: "6", target: "7" },
            { source: "7", target: "5" },
            { source: "5", target: "8", label: "No (Start Display)" },
            { source: "8", target: "9" },
          ],
        },
        ...
        samples: [
          {
            input: "2\n1 Alice 95.5\n2 Bob 88.0",
            output: "Student records stored and displayed successfully.",
          },
        ],
      },
    ],
    ...
    subExperiments: [
      {
        ...
        flowchart: {
          nodes: [
            ...
            { id: "3", type: "process", label: "head = NULL" },
            { id: "4", type: "process", label: "Insert node using malloc()" },
            { id: "5", type: "decision", label: "Delete node?" },
            { id: "6", type: "process", label: "Update pointers & free node" },
            { id: "7", type: "output", label: "Traverse & display list" },
    ...
    subExperiments: [
      {
        ...
        flowchart: {
          nodes: [
            { id: "1", type: "start", label: "Start" },
            { id: "2", type: "process", label: "Define Student Structure" },
            { id: "3", type: "process", label: "Open file (r/w/a mode)" },
            {
              id: "4",
              type: "process",
              label: "Add / Update / Display Records",
            },
            { id: "5", type: "decision", label: "Operation Type?" },
            {
              id: "6",
              type: "process",
              label: "Write new record (append mode)",
            },
            { id: "7", type: "process", label: "Read & display records" },
            { id: "8", type: "process", label: "Modify record & rewrite file" },
            { id: "9", type: "process", label: "fflush() + fclose()" },
          ...
          edges: [
            ...
            { source: "5", target: "6", label: "Add" },
            { source: "5", target: "7", label: "Display" },
            { source: "5", target: "8", label: "Update" },
        ...
        samples: [
          {
            input: "Add: 1 Alice 95.5",
            output: "Student record stored successfully.",
          },
        ],
      },
    ],
    ...
    subExperiments: [
      {
        ...
        flowchart: {
          nodes: [
            { id: "1", type: "start", label: "Start" },
            { id: "2", type: "process", label: "Define Book structure" },
            {
              id: "3",
              type: "process",
              label: "Initialize storage (array/pointer)",
            },
            { id: "4", type: "process", label: "Add Book (function)" },
            { id: "5", type: "process", label: "Display Books (function)" },
            { id: "6", type: "process", label: "Search Book (function)" },
            { id: "7", type: "process", label: "File Operations (save/load)" },
            {
              id: "8",
              type: "process",
